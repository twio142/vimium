...
const allCommands = [
...

  {
    ...
    desc: "Copy the current Title to the clipboard",
    group: "navigation",
    noRepeat: true,
  },

  {
    name: "copyCurrentMDLink",
    desc: "Copy the markdown link to the clipboard",
    group: "navigation",
    noRepeat: true,
  },
  ...
  {
    name: "LinkHints.activateModeToCopyImageUrl",
    desc: "Copy an image URL to the clipboard",
    group: "navigation",
    advanced: true,
  },
  ...
  {
    name: "Vomnibar.restoreSession",
    desc: "Open a recently closed tab",
    group: "vomnibar",
    topFrame: true,
  },

  {
    name: "Vomnibar.moveTabToWindow",
    desc: "Move current tab to an existing window",
    group: "vomnibar",
    topFrame: true,
  },

  {
    name: "vomnibarWithSelection",
    desc: "Open vomnibar with selection",
    group: "vomnibar",
    topFrame: true,
  },

  {
    name: "vomnibarWithSelectionInNewTab",
    desc: "Open vomnibar with selection in new tab",
    group: "vomnibar",
    topFrame: true,
  },
  ...
  {
    name: "openTabInIncognito",
    desc: "Open tab in incognito window",
    group: "tabs",
    advanced: true,
  },
